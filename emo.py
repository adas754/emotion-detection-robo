...
def generate_image_response(image):
    ...
    prompt = "Analyze the emotions conveyed by the person in this image and respond directly to them,using 'you' in a short and empathetic way, give exact emotion . if sad then then tell sad , if happy then tell happy"
